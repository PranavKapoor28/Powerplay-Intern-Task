...
public class FloorPlan1PinFragment extends Fragment {

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(layout.floor_pin_fragment, container, false);
        final FloorPlan1Activity activity = (FloorPlan1Activity)getActivity();

        final PinView imageView = rootView.findViewById(id.imageView);
        imageView.setImage(ImageSource.asset("floorPlans/0.jpg"));
